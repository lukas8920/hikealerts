...
public class EventController {
    ...
    @Operation(summary = "Publish your own event.", description = "Allows to publish an event and requests hiking-alerts.org to match the event with geospatial data. Only registered organisations can publish via the API. On request via mail you can become a member of an official institution. The events are then published via this institution. And only members of the institution can adjust or delete the event.", operationId = "queryEvents")
    @ApiResponses(value = {
